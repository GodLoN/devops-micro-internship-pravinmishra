...
![Screenshot 1](screenshots/week-3-assign-2-task-1-ss-1.png)
...
![Screenshot 2](screenshots/week-3-assign-2-task-2-ss-2.png)
...
![Screenshot 3](screenshots/week-3-assign-2-task-3-ss-3.png)
...
![Screenshot 4](screenshots/week-3-assign-2-task-4-ss-4.png)
...
![Screenshot 5](screenshots/week-3-assign-2-task-5-ss-5.png)
...
![Screenshot 6](screenshots/week-3-assign-2-task-6-ss-6.png)
...
![Screenshot 7](screenshots/week-3-assign-2-task-7-ss-7.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![Screenshot 8](screenshots/week-3-assign-2-task-7-ss-8.png)
...
![Screenshot 9](screenshots/week-3-assign-2-task-8-ss-9.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![Screenshot 10](screenshots/week-3-assign-2-task-8-ss-10.png)
...
`https://www.linkedin.com/posts/godwin-obi-008a12177_devops-aws-cloudcomputing-activity-7481847943566811136-AqzP?utm_source=share&utm_medium=member_desktop&rcm=ACoAACn5hogBVyHnSR92cyBf5EzFBZEMSepEVPM`

---

#### Screenshot — LinkedIn post showing the deployed application

![Screenshot 11](screenshots/week-3-linkedin-post-screenshot.png)

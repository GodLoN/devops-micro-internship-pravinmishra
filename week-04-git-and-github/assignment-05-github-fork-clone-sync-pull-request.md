...
![Screenshot 1](screenshots/week-4-assign-5-task-0-ss-1.png)
...
![Screenshot 2](screenshots/week-4-assign-5-task-1-ss-2.png)
...
![Screenshot 3](screenshots/week-4-assign-5-task-2-ss-3.png)
...
![Screenshot 4](screenshots/week-4-assign-5-task-3-ss-4.png)

---

#### Screenshot 5 — Output of `git commit`

![Screenshot 5](screenshots/week-4-assign-5-task-3-ss-5.png)
...
![Screenshot 8](screenshots/week-4-assign-5-task-5-ss-8.png)

---

#### Screenshot 9 — Successfully created Pull Request page with the PR number visible

![Screenshot 9](screenshots/week-4-assign-5-task-5-ss-9.png)
...
`https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/342`
...
`https://www.linkedin.com/posts/godwin-obi-008a12177_devops-github-opensource-share-7486170951613865985-RhaG/?utm_source=share&utm_medium=member_desktop&rcm=ACoAACn5hogBVyHnSR92cyBf5EzFBZEMSepEVPM`

---

#### Screenshot — LinkedIn post showing your successfully created Pull Request

![Screenshot 10](screenshots/week-4-assign-5-task-linkedin-post.png)
...
`https://github.com/GodLoN/devops-micro-internship-interviews.git`

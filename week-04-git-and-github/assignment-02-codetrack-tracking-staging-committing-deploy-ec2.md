...
![Screenshot 1](screenshots/week-4-assign-2-task-1-ss-1.png)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![Screenshot 2](screenshots/week-4-assign-2-task-1-ss-2.png)
...
![Screenshot 4](screenshots/week-4-assign-2-task-3-ss-4.png)
...
![Screenshot 5](screenshots/week-4-assign-2-task-4-ss-5.png)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![Screenshot 6](screenshots/week-4-assign-2-task-4-ss-6.png)
...
![Screenshot 7](screenshots/week-4-assign-2-task-5-ss-7.png)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![Screenshot 8](screenshots/week-4-assign-2-task-5-ss-8.png)
...
![Screenshot 9](screenshots/week-4-assign-2-task-6-ss-9.png)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![Screenshot 10](screenshots/week-4-assign-2-task-6-ss-10.png)

---

#### Screenshot 11 — Output of `git commit`

![Screenshot 11](screenshots/week-4-assign-2-task-6-ss-11.png)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![Screenshot 12](screenshots/week-4-assign-2-task-6-ss-12.png)
...
![Screenshot 13](screenshots/week-4-assign-2-task-7-ss-13.png)

---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![Screenshot 14](screenshots/week-4-assign-2-task-7-ss-14.png)

---

#### Screenshot 15 — Browser showing the CodeTrack site loaded at `http://<EC2_PUBLIC_IP>`, with your Full Name and Group Name visible

![Screenshot 15](screenshots/week-4-assign-2-task-7-ss-15.png)
...
`https://www.linkedin.com/posts/godwin-obi-008a12177_dmibypravinmishra-linux-bash-share-7484746152383438849-KPma/?utm_source=share&utm_medium=member_desktop&rcm=ACoAACn5hogBVyHnSR92cyBf5EzFBZEMSepEVPM`

---

#### Screenshot — LinkedIn post showing the deployed CodeTrack application

![Screenshot 16](screenshots/week-4-assign-2-linkedin-post.png)

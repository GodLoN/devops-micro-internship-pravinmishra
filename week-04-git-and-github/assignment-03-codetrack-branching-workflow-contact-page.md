...
![Screenshot 1](screenshots/week-4-assign-3-task-1-ss-1.png)
...
![Screenshot 2](screenshots/week-4-assign-3-task-2-ss-2.png)
...
![Screenshot 3](screenshots/week-4-assign-3-task-3-ss-3.png)

---

#### Screenshot 4 — Output of `git commit`

![Screenshot 4](screenshots/week-4-assign-3-task-3-ss-4.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![Screenshot 5](screenshots/week-4-assign-3-task-3-ss-5.png)
...
![Screenshot 6](screenshots/week-4-assign-3-task-4-ss-6.png)

---

#### Screenshot 7 — Output of `git commit`

![Screenshot 7](screenshots/week-4-assign-3-task-4-ss-7.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![Screenshot 8](screenshots/week-4-assign-3-task-4-ss-8.png)
...
![Screenshot 9](screenshots/week-4-assign-3-task-5-ss-9.png)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![Screenshot 10](screenshots/week-4-assign-3-task-5-ss-10.png)
...
![Screenshot 11](screenshots/week-4-assign-3-task-6-ss-11.png)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![Screenshot 12](screenshots/week-4-assign-3-task-6-ss-12.png)

---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![Screenshot 13](screenshots/week-4-assign-3-task-6-ss-13.png)
...
![Screenshot 14](screenshots/week-4-assign-3-task-7-ss-14.png)
...
![Screenshot 15](screenshots/week-4-assign-3-task-8-ss-15.png)

...
![Screenshot 1](screenshots/week-8-assign-2-task-0-ss-1.png)
...
![Screenshot 2](screenshots/week-8-assign-2-task-1-ss-2.png)
...
![Screenshot 3](screenshots/week-8-assign-2-task-1-ss-3.png)
...
![Screenshot 4](screenshots/week-8-assign-2-task-2-ss-4.png)
...
![Screenshot 5](screenshots/week-8-assign-2-task-3-ss-5.png)

---

#### Screenshot 6 — Terraform apply output showing successful completion

![Screenshot 6](screenshots/week-8-assign-2-task-3-ss-6.png)

---

#### Screenshot 7 — Terraform output showing the public IP address of the EC2 instance

![Screenshot 7](screenshots/week-8-assign-2-task-3-ss-7.png)
...
**EC2 Public IP Address:** `3.228.14.6`
...
![Screenshot 8](screenshots/week-8-assign-2-task-4-ss-8.png)

---

#### Screenshot 9 — Browser showing the Nginx page successfully loaded using the EC2 instance public IP

![Screenshot 9](screenshots/week-8-assign-2-task-4-ss-9.png)
...
![Screenshot 10](screenshots/week-8-assign-2-task-5-ss-10.png)

...
![Screenshot 1](screenshots/week-6-assign-4-task-1-ss-1.png)

---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![Screenshot 2](screenshots/week-6-assign-4-task-1-ss-2.png)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![Screenshot 3](screenshots/week-6-assign-4-task-1-ss-3.png)
...
![Screenshot 4](screenshots/week-6-assign-4-task-2-ss-4.png)

---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![Screenshot 5](screenshots/week-6-assign-4-task-2-ss-5.png)
...
![Screenshot 6](screenshots/week-6-assign-4-task-3-ss-6.png)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![Screenshot 7](screenshots/week-6-assign-4-task-3-ss-7.png)
...
![Screenshot 8](screenshots/week-6-assign-4-task-4-ss-8.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![Screenshot 9](screenshots/week-6-assign-4-task-4-ss-9.png)

---

#### Screenshot 10 — Output of `mysql --version`

![Screenshot 10](screenshots/week-6-assign-4-task-4-ss-10.png)
...
![Screenshot 11](screenshots/week-6-assign-4-task-5-ss-11.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![Screenshot 12](screenshots/week-6-assign-4-task-5-ss-12.png)
...
![Screenshot 13](screenshots/week-6-assign-4-task-6-ss-13.png)
...
![Screenshot 17](screenshots/week-6-assign-4-task-8-ss-17.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![Screenshot 18](screenshots/week-6-assign-4-task-8-ss-18.png)
